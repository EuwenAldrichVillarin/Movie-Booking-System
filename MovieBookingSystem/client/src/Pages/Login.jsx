...
export default function Login() {
  ...
  const handleSignupClick = () => {
    // Clear errors when switching to signup
    setFormErrors({});
    setIsAnimating(true);
    setTimeout(() => {
      setIsSignup(true);
  ...
  const handleBackToLogin = () => {
    // Clear errors when switching back to login
    setFormErrors({});
    setIsAnimating(true);
    setTimeout(() => {
      setIsSignup(false);
  ...
  const getInputClassName = (fieldName) => {
    const baseClass = "w-full px-3 sm:px-4 py-2 sm:py-3 lg:py-3 bg-gray-800 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-transparent text-sm sm:text-base lg:text-base";
    const errorClass = formErrors[fieldName] ? "border-red-500" : "border-gray-600";
    return `${baseClass} ${errorClass}`;
  };

  const getSignupInputClassName = (fieldName) => {
    const baseClass = "w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-800 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-transparent text-sm sm:text-base";
    const errorClass = formErrors[fieldName] ? "border-red-500" : "border-gray-600";
    return `${baseClass} ${errorClass}`;
  };
  ...
  return (
    <div className="min-h-screen flex flex-col xl:flex-row">
      ...
      {!isSignup ? (
        ...
        // Signup Form with Success Loading State
        <div className={`fixed inset-0 flex items-center justify-center z-50 transition-all duration-500 ease-in-out ${
          ...
          <div className="w-full max-w-md sm:max-w-lg lg:max-w-xl xl:max-w-2xl rounded-2xl bg-gray-100 space-y-6 lg:space-y-8 p-6 sm:p-8 lg:p-10 xl:p-12 mx-4 sm:mx-6">
            ...
            {isSuccessLoading && (
              <div className="absolute inset-0 bg-gray-100 bg-opacity-90 flex items-center justify-center rounded-2xl z-10">
                <div className="text-center">
                  <div className="w-16 h-16 border-t-4 border-b-4 border-red-600 rounded-full animate-spin mx-auto mb-4"></div>
                  <p className="text-gray-800 font-semibold text-lg">Redirecting to login...</p>
                  <p className="text-gray-600 text-sm mt-2">Your account was created successfully!</p>
                </div>
              </div>
            )}
            ...
            <form className="space-y-4 lg:space-y-6" onSubmit={handleSignupSubmit}>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
                <div className="sm:col-span-1">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={getSignupInputClassName('firstName')}
                ...
                <div className="sm:col-span-1 lg:col-span-1">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={getSignupInputClassName('lastName')}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={formData.email}
                    onChange={handleChange}
                    className={getSignupInputClassName('email')}
                    placeholder="Enter your email"
                    required
                    disabled={isSuccessLoading}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={getSignupInputClassName('phone')}
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.password}
                    onChange={handleChange}
                    className={getSignupInputClassName('password')}
                    placeholder="Enter your password"
                    minLength="6"
                    required
                    disabled={isSuccessLoading}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={getSignupInputClassName('confirmPassword')}
              ...
              <div className="flex flex-row gap-4 pt-4">
                ...
                <button
                  ...
                  disabled={isSuccessLoading}
                  className={`flex-1 py-3 px-4 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 text-sm sm:text-base ${
                    isSuccessLoading
                      ? 'opacity-50 cursor-not-allowed'
                      : 'cursor-pointer hover:scale-105 active:scale-95'
                  }`}
